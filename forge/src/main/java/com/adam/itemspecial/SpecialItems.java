...
public class SpecialItems {
	...
	@SidedProxy(clientSide="com.adam.itemspecial.proxy.client.ClientProxy", 
				serverSide="com.adam.itemspecial.proxy.server.ServerProxy")
