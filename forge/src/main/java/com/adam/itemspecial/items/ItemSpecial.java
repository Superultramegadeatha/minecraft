package com.adam.itemspecial.items;
...
public class ItemSpecial extends Item{
    ...
    //	getAbilityFromNBT(stack).useAbility(world, player, weight);
    //}
    	...
    	if (stack == null){
            ...
            if (nbttaglist == null || nbttaglist.hasNoTags()){
                ...
                for (int j = 0; j < nbttaglist.tagCount(); ++j){
                    ...
                    if (enchantment != null){
                    	enchantment.useAbility(world, player, (byte)(1.0*weight/enchantment.getMaxLevel()*level));
                    }
                }
            }
        }
